...
namespace HospitalManagement.Controllers
{
    public class QualificationController : Controller
    {
        ...
        public ActionResult Create([Bind(Include="ID,Name,Status")] Qualification qualification)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include="ID,Name,Status")] Qualification qualification)
        {
            if (ModelState.IsValid)
            {
